package fr.neocraft.main.render.Entity;
...
public class NeoEntityRenderer extends EntityRenderer{
	   ...
	   private static final Logger logger = LogManager.getLogger();
	    ...
	    private float thirdPersonDistance = 0F;
	    public float ToReachthirdPersonDistance = 0F;
	    private float thirdPersonDistanceY = 0F;
	    public float ToReachthirdPersonDistanceY = 0F;
	    ...
	    public NeoEntityRenderer( Minecraft p_i45076_1_, IResourceManager p_i45076_2_)
	    {
	     ...
	     */
	    private float pasView = 0F, pasView2 = 0.1F;
	    ...
	    {//<>
	        ...
	        if(!ClientPlayerData.Cam.Cinematic(p_78467_1_))
	        {
		    	if(this.mc.gameSettings.thirdPersonView == 0)
		    	{
			    	...
			    	{
			    		this.ToReachthirdPersonDistance = 3;
			    		this.pasView = 0.6F;
			    		this.pasView2 = 0.2F;
			    		this.ToReachthirdPersonDistanceY = -1F;
			    		 GL11.glTranslatef(0.0F, this.thirdPersonDistanceY, 0.0F);
			    	} else
			    	{
			    		this.ToReachthirdPersonDistance = 16F;
			    		this.ToReachthirdPersonDistanceY = -2F;
			    		this.pasView = 1.6F;
			    		this.pasView2 = 0.2F;
			    		 GL11.glTranslatef(0.0F, this.thirdPersonDistanceY, 0.0F);
			    	} 
			    	
			    	if(this.thirdPersonDistance < this.ToReachthirdPersonDistance)
			    	{
			    		this.thirdPersonDistance += pasView* p_78467_1_;
			    	}
			    	else if(this.thirdPersonDistance > this.ToReachthirdPersonDistance +pasView)
			    	{
			    		this.thirdPersonDistance -= pasView* p_78467_1_;
			    	}
			    	if(this.thirdPersonDistanceY < this.ToReachthirdPersonDistanceY)
			    	{
			    		this.thirdPersonDistanceY += pasView2* p_78467_1_;
			    	}
			    	else if(this.thirdPersonDistanceY > this.ToReachthirdPersonDistanceY + pasView2)
			    	{
			    		this.thirdPersonDistanceY -= pasView2* p_78467_1_;
			    	} 
			    	 d1-=this.thirdPersonDistanceY;
		    	}
		        ...
		        {
		            double d7 = this.thirdPersonDistance;
		            float f2;
		            float f6;
		            ...
		            else
		            {
		                ...
		                for (int k = 0; k < 8; ++k)
		                {
		                    ...
		                    {
		                        double d6 = movingobjectposition.hitVec.distanceTo(Vec3.createVectorHelper(d0, d1+this.thirdPersonDistanceY, d2));
	            ...
	            if (this.mc.currentScreen != null)
	            {
	                ...
	                catch (Throwable throwable)
	                {
	                    ...
	                    crashreportcategory.addCrashSectionCallable("Screen name", new Callable()
	                    {
	                        ...
	                        public String call()
	                        {
	                            return NeoEntityRenderer.this.mc.currentScreen.getClass().getCanonicalName();
	                        }
	                    });
	    ...
	    public void renderWorld(float p_78471_1_, long p_78471_2_)
	    {
	        ...
	        for (int j = 0; j < 2; ++j)
	        {
	            ...
	            ActiveRenderInfo.updateRenderInfo(this.mc.thePlayer, this.mc.gameSettings.thirdPersonView == 2 || this.mc.gameSettings.thirdPersonView == 1);
