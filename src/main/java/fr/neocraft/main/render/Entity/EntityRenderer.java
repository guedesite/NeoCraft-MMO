...
public class EntityRenderer extends Render
{
    ...
    public ResourceLocation res = new ResourceLocation("textures/entity/steve.png");

    public static float NAME_TAG_RANGE = 64.0f;
    public static float NAME_TAG_RANGE_SNEAK = 32.0f;

    public EntityRenderer(float p_i1261_2_)
    {
    ...
    public float renderSwingProgress(EntityLivingBase p_77040_1_, float p_77040_2_)
    {
    ...
    public void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_) {}

    /**
     * renders arrows the Entity has been attacked with, attached to it
     */
    public void renderArrowsStuckInEntity(EntityLivingBase p_85093_1_, float p_85093_2_)
    {
    ...
    public int inheritRenderPass(EntityLivingBase p_77035_1_, int p_77035_2_, float p_77035_3_)
    {
    ...
    public void func_82408_c(EntityLivingBase p_82408_1_, int p_82408_2_, float p_82408_3_) {}
    ...
    public boolean func_110813_b(EntityLivingBase p_110813_1_)
    {
    ...
    public void func_96449_a(EntityLivingBase p_96449_1_, double p_96449_2_, double p_96449_4_, double p_96449_6_, String p_96449_8_, float p_96449_9_, double p_96449_10_)
    {
